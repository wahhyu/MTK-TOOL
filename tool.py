...
def about():
    ...
    print ('')
    print ('Kami segenap anggota team INDONESIAN-ERROR-SYSTEM mengucapkan Terimakasih karena sudah menggunakan tool buatan kami . ')
    print ('')
